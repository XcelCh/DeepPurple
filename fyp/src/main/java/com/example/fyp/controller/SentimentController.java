...
public class SentimentController {
	...
	private TextSentimentAnswer textAnalyzer(String sentence) {
		String apiKey = "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";
		...
		// OVERALL CONTENT
		// prompt = "Perform a sentiment analysis on the relevant sentences from" +
		// sentence;
		...
		// FIRST VERSION
		// prompt = "Analyze the given sentence " + sentence + "and detect the emotions
		// associated with highlighted keywords or sentences, then give explanation and
		// associate them with a color in hexcode."
		// + " Please format the answer as [Emotion]|[highlighted keyword or
		// sentence]|[explanation]|[hexcode]\n[IF MORE EMOTIONS]";
		...
		// response =
		// service.createCompletion(explanationRequest).getChoices().get(0).getText();
