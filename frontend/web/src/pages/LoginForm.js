                ...
                <form class="space-y-4 md:space-y-6" onSubmit={handleLogin}>
                  ...
                  <div>
                    ...
                    {loginError && (
                      <p className="text-red-500 text-sm mt-2">
                        Wrong email or password. Try again or click Forgot
                  ...
                  <div class="flex flex-col items-left">
                    <p class="text-sm font-regular text-gray-500 dark:text-gray-400">
                      ...
                      <a
                        href="#"
                        class="font-regular text-blue-600 hover:underline dark:text-primary-500"
                      >
                        Create an account
                      </a>
                    </p>
                    <a
                      href="#"
                      class="text-sm font-regular text-blue-600 hover:underline dark:text-primary-500"
                    >
                      Forgot password?
                    </a>
                  </div>
