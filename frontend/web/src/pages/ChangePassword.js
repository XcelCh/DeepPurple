...
function ChangePassword() {
  ...
  const handleSave = (e) => {
    ...
    if (!passwordPattern.test(formData.currentPassword)) {
      setCurrentMessage('Password must be at least 6 characters and should include a combination of one uppercase, lowercase letter and numbers.');
      return;
    }
